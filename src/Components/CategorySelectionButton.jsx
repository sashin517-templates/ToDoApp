...
const CategorySelectionButton = ({
  ...
  return (
    <div>
      <div
        className="bg-ltf flex gap-5 items-center px-5 py-5 w-full rounded-2xl shadow-[0px_4px_4px_rgba(0,0,0,0.05)] cursor-pointer"
      ...
      >
        <img
          ...
          alt="Category Icon"
          className="object-contain shrink-0 self-stretch aspect-square"
        />
