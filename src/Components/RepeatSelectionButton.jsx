  ...
  return (
    <div>
      ...
      <div className="flex">
        <button
          type="button"
          className="bg-ltf flex gap-1.5 items-center self-stretch px-5 py-5 rounded-2xl min-h-[40px] shadow-[0px_4px_4px_rgba(0,0,0,0.05)]"
              ...
              {["Daily", "Weekly", "Monthly"].map((option) => (
                <div
                  ...
                  className={`px-4 py-2 bg-violet-100 rounded-lg text-center cursor-pointer hover:bg-ltf ${
                    repeatOption === option ? "bg-ltf font-bold" : ""
                  }`}
