...
const ReminderSelectionButton = ({
  ...
  return (
    <div className="flex">
      ...
      <button
        type="button"
        className="bg-ltf flex items-center self-stretch px-5 py-5 rounded-2xl min-h-[40px] shadow-[0px_4px_4px_rgba(0,0,0,0.05)]"
      ...
      >
        ...
        <div className="self-stretch my-auto">
          {reminderOption === "None"
            ? "Reminder"
            : `${reminderOption}${isSoundEnabled ? " with Sound" : ""}`}
        </div>
      </button>
              ...
              {reminderOptions.map((option, index) => (
                <div
                  ...
                  className={`px-4 py-2 bg-violet-100 rounded-lg text-center cursor-pointer hover:bg-ltf ${
                    reminderOption === option ? "bg-ltf font-bold" : ""
                  }`}
