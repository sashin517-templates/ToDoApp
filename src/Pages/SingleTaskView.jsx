...
function SingleTaskView() {
  ...
  const theme = isDarkMode
    ? {
        background: "#161221", // Dark background
        card: "#2D1E5D", // Dark card
        textPrimary: "#FFFFFF", // White text for dark mode
        textSecondary: "#AAAAAA", // Light gray text for dark mode
        buttonBg: "#4B0082", // Dark button color
        buttonText: "#FFFFFF", // White text on buttons
        iconColor: "#FFD700", // Icon color in dark mode
        darkPurple: "#4B0082", // Dark purple color for Set Icon
      }
    : {
        background: "#F9F9F9", // Light background
        card: "#FFFFFF", // Light card
        textPrimary: "#333333", // Dark text for light mode
        textSecondary: "#666666", // Gray text for light mode
        buttonBg: "#E6E6FF", // Light button color
        buttonText: "#4A4A4A", // Dark text on buttons
        iconColor: "#4B0082", // Icon color in light mode
        darkPurple: "#4B0082", // Light mode default dark purple (unchanged)
      };
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", justifyContent: "space-between", marginTop: "1.5rem" }}>
            ...
            >
              <span style={{ fontSize: "1.2rem", marginRight: "0.5rem" }}>🔔</span> Reminder
            </button>
            <button
            ...
            >
              <span style={{ fontSize: "1.2rem", marginRight: "0.5rem" }}>🔁</span> Repeat
            </button>
          </div>
              ...
              {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((day) => (
                <button
                  ...
                  style={{
                    ...
                    padding: "0.5rem 1rem",
                    borderRadius: "20px",
                    backgroundColor: selectedRepeatDays.includes(day) ? "#4B0082" : "#D4E2FF",
                    color: selectedRepeatDays.includes(day) ? "#FFFFFF" : "#0056B3",
                    cursor: "pointer",
                  }}
                >
                  {day}
